...
//  Quizzler
//
//  Created by rommel fowler on 8/24/18.
...
class QuestionBank{
//    NOTE: You can place values and specify a type of value in an array
//    This array has a type of class value called Question.
    
    var list = [Question]()
    
    init() {
//        Please find the instructions for creating question object
